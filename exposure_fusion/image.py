"""
    Modificado de : https://github.com/Rachine/ExposureFusion/blob/master
"""
...
class Image(object):
    ...
    def crop_image(self, n):
        ...
        self.array = self.array[int(begin_height):int(max_height + begin_height), int(begin_width):int(max_width + begin_width)]
